...
**Estado:** base implementada; alcance revisado tras Electrical Epic 2.
...
| Cortocircuito de red (Ik'', Ip) | `ex-short-circuit` | No |
...
- Caída de tensión a lo largo del corredor — existe como cálculo derivado de screening; no equivale a flujo de carga ni a diseño final del cable.
- Resistencia adiabática del conductor (`I = k·S/√t`) — existe como utilidad aislada y evidenciada; no calcula `Ik''`, `Ip`, aportes de inversores ni coordinación de protecciones.
