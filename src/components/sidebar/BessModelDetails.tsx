...
export function BessModelDetails({
  ...
  const rows = [
    ...
    [isEs ? "Duracion" : "Duration", model.durationHours === null ? "-" : `${formatNumber(model.durationHours, 2)} h`],
    ...
    [isEs ? "Quimica" : "Chemistry", model.chemistry ?? "-"],
    [isEs ? "Area" : "Area", formatAreaM2(model.areaM2, { digits: 2, locale })],
